    ...
    <div class="main">
        <div class="left-container">
          ...
          <div class="sidebarSmall">
            <ul>
                <li class="active" data-bs-toggle="tooltip" data-bs-placement="right" title="Home"><a href="home.php"><i class="fas fa-home"></i></a></li>
                <?php
                    if($_SESSION['uid'] == "")
                    {
        ...
        <div class="right-container">
            <div class="card bg-dark text-white" style="border: none;">
                <img src="image/banner.jpg" class="card-img" alt="banner">
                <div class="card-img-overlay" style="margin: 15px 15px;">
                  <h1 class="card-title" style="color: blueviolet;">Feel The Music</h5>
                  <p class="card-text" style="color: black; margin-right: 40%;">Let the Music Speak! Life is a song, love is the music. Like music to my ears. Love is my weapon, music is my religion, peace is in my soul.</p>
              ...
              <div class="type-music">
                  <br>
                  <h3><b> Top Songs </b></h3>
                  <div id="display_song" class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 d-flex">
                    <!-- <div class="col">
                      <div class="card h-100 p-2">
                        <img src="image/cover.jpg" class="card-img-top rounded-3" alt="...">
                        <div class="card-body">
                          <h5 class="card-title">On MyWay</h5>
                          <small class="card-text text-muted">Alan Walker</small>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="card h-100 p-2 ">
                        <img src="image/cover.jpg" class="card-img-top  rounded-3" alt="...">
                        <div class="card-body">
                          <h5 class="card-title">One Thing Right</h5>
                          <small class="card-text text-muted">Marshmello</small>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="card h-100 p-2 ">
                        ...
                        <div class="card-body">
                          ...
                          <small class="card-text text-muted">The Chainsmokers</small>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 p-2 bod">
                          <img src="image/cover.jpg" class="card-img-top rounded-3" alt="...">
                          <div class="card-body">
                            <h5 class="card-title">On MyWay</h5>
                            <small class="card-text text-muted">Alan Walker</small>
...
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <!-- Footer -->
    ...
    <script>
    var display_song = document.getElementById("display_song");
    window.onload = function(){
        // let userid = <?php echo $_SESSION['uid']?>;
        // if(userid != ""){
            // searchsong.classList.add("active");
            let xhr = new XMLHttpRequest();
            xhr.open("POST","php/homepage.php",true);
            xhr.onload = ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
                        display_song.innerHTML = data;
                    }
                }
            }
