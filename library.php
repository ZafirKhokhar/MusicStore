  ...
  ?>
    ...
    <div class="main">
          ...
          <div class="sidebar">
              <ul>
                  ...
                  <?php
                    if($_SESSION['uid'] == "")
                    {
                      echo '<li class="active"><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-sliders-h"></i>Library</a></li>';
                    }
                    else {
                      echo '<li class="active"><a href="library.php"><i class="fas fa-sliders-h"></i>Library</a></li>';
                    }
                  ?>
              </ul>
          </div>
          <div class="sidebarSmall">
            <ul>
                ...
                <?php
                    if($_SESSION['uid'] == "")
                    {
                      echo '<li class="active" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-toggle="tooltip" data-bs-placement="right" title="Library"><a href="#"><i class="fas fa-sliders-h"></i></a></li>';
                    }
                    else {
                      echo '<li class="active" data-bs-toggle="tooltip" data-bs-placement="right" title="Library"><a href="library.php"><i class="fas fa-sliders-h"></i></a></li>';
                    }
                  ?>
            </ul>
          </div>
        ...
        <div class="right-container">
          <h3><b>Library</b></h3>
          <div class="options">
            <div class="opt"><button onclick="location.href = 'home.php'">Home</button></div>
            <div class="opt"><button onclick="location.href = 'favourite.php'">Favourite</button></div>
            <div class="opt"><button onclick="location.href = 'artist.php'">Artist</button></div>
            <div class="opt"><button onclick="location.href = 'genre.php'">Genre</button></div>
            <div class="opt"><button onclick="location.href = 'playlist.php'">Playlist</button></div>
          </div>
          <div class="heading">
            <h4><b>Your Requested Songs</b></h4>
          </div>
            ...
            <!-- <h5>Requests</h5>
              <li>
                ...
                <div class="more">
                    ...
                    <a onclick="deletesong('.$row['sid'].')"><i id="done" class="material-icons-outlined">done</i></a>
              ...
              <li>
                ...
                <div class="song-info">
                    ...
                    <div class="song-detail">
                    <span class="name">hamnava mere</span>
                    </div>
                </div>
                <div class="more">
                    <audio class="song1" src="Tracks/.mp3"></audio>
                    <span id="song1" class="audio-duration">3:40 </span>
                    <a onclick="setrid(2)" data-bs-toggle="modal" data-bs-target="#exampleModal">Pending</a>
                    <a onclick="deletesong('.$row['sid'].')"><i id="close" class="material-icons">close</i></a>
                </div>
                </div>
              </li> -->
          ...
          <div class="request">
            ...
            <form id="reqform">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="reqmsg" placeholder="Enter Song name..">
                <div class="form-text">You will get your requested song soon.</div>
              </div>
...
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <!-- Footer -->
    ...
    function handleForm(event) { 
      ...
      reqform.addEventListener('submit', handleForm);

    var msg = document.getElementById('msg');

    var submitbtn = document.getElementById("submitbtn");
    submitbtn.onclick = function(){
      var rmsg = document.getElementById("reqmsg").value;
        let reqmsg = rmsg;
        if(reqmsg != ""){
            ...
            xhr.onload = ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                      ...
                      if(data == "Success"){
                        msg.innerHTML = 'Successfully Song Requested';
                      }
                    }
                }
            }
            xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xhr.send("reqmsg=" + reqmsg);
        }
        else{
    ...
    window.onload = function (){
      // searchsong.classList.add("active");
      let xhr = new XMLHttpRequest();
      xhr.open("POST","php/LoadReq.php",true);
      xhr.onload = ()=>{
          if(xhr.readyState === XMLHttpRequest.DONE){
              if(xhr.status === 200){
                  let data = xhr.response;
