    ...
    <div class="main">
          ...
          <div class="sidebarSmall">
            <ul>
                ...
                <?php
                  ...
                  ?>
                <li class="active" data-bs-toggle="tooltip" data-bs-placement="right" title="Search"><a href="search.php"><i class="fas fa-search"></i></a></li>
        ...
        <div class="right-container">
          <div class="search">
            <form id="myForm">
                <button><i class="fas fa-search"></i></button>
                <input type="text" id="ssearch" name="search" placeholder="Search Songs">
            </form>
          </div>

          <div class="search-heading">
            <h5>Search Results</h4>
          </div>
          <div class="search-list">
            <ul id="search_data">
              <h4 class='text-muted' style='text-align: center;'>Search by Song name, artist or genre</h4>
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    ...
    searchsong.onkeyup = ()=>{
        ...
        if(searchTerm != ""){
            ...
            xhr.open("POST","php/live_search.php",true);
            xhr.onload = ()=>{
            ...
            search_data.innerHTML = "<h4 class='text-muted' style='text-align: center;'>Search by Song name, artist or genre</h4>";
        }
