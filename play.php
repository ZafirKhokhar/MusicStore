<?php
    ...
    error_reporting(0);
    $ssid=$_GET["ssid"];
    $query = "SELECT * FROM song WHERE sid = {$ssid}";
    ...
    $fav = false;
    $check = "SELECT * FROM favourite WHERE uid = '{$_SESSION['uid']}' AND sid = '{$ssid}' ";
  ...
  <script>
      allMusic = <?php echo json_encode($arraydata);  ?>;
    </script>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    ...
    <link rel="stylesheet" href="playsong.css">
</head>
<body>
  <?php
    session_start();
  ...
  ?>
    ...
    <div class="main">
        ...
        <div class="right-container">
            <div class="wrapper">
                <div class="top-bar">
                  <form action="php/downloadfast.php" method="get">
                    <!-- <i id="download_click" class="material-icons">download</i> -->
                    <input type="hidden" name="sid" id="songid" value=" ">
                    <button id="Download" type="submit"><i id="download_click" class="material-icons">download</i></button>
                  </form>
                    ...
                    <ul id="listname" class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                ...
                <div class="controls">
                    ...
                    <div class="favorite">
                      <?php
                        if($fav == true){
                          echo '<a href="#" onclick="addFavourite()"><i id="favorite-tick" class="material-icons">favorite</i></a>';
                        }
                        else {
                          $fav = false;
                          echo '<a href="#" onclick="addFavourite()"><i id="favorite-tick" class="material-icons">favorite_border</i></a>';
                        }
                      ?>
                    </div>
                </div>
...
<!-- JacaScript Files -->
    ...
    <script>
      ...
      function addFavourite(){
        let selectTerm = <?php echo $ssid ?>;
        if(selectTerm != ""){
            // searchsong.classList.add("active");
            let xhr1 = new XMLHttpRequest();
            xhr1.open("POST","php/addFav.php",true);
            xhr1.onload = ()=>{
            ...
            xhr1.send("searchTerm=" + selectTerm);
        }
        else {
            search_data.innerHTML = "<h4 class='text-muted' style='text-align: center;'>No  Data avalible for this genre Error</h4>";
        }
      }
      ...
      window.onload = function(){
        let userid = <?php echo $_SESSION['uid'];?>;
          ...
          xhr.open("POST","php/plistname.php",true);
          xhr.onload = ()=>{
      ...
      function addtoPlaylist(plid){
        ...
        if(pl != "" && sid != ""){
            ...
            xhr2.open("POST","php/addsongPL.php",true);
            xhr2.onload = ()=>{
