            ...
            <div class="modal-content">
              ...
              <div class="modal-body h-100 mt-3 mb-3">
                <form class="space" id="myForm">
                  ...
                  <input type="hiddden" id="rid"  name="rid" class="form-control" placeholder="Request ID..." >
    ...
    <div class="main">
        <div class="admin-container container">
          <div class="options">
            ...
            <!-- <div class="opt updatesong"><button onclick="location.href = 'Request.php'" type="button">Requests for Song</button></div> -->
            <div><h3>Users Request</h3></div>
          </div>
            ...
            <ul id="search_data">
              ...
              <li>
                ...
                <div class="song-info">
                    ...
                    <p class="artist">User : farhan</p>
                    </div>
                </div>
                <div class="more">
                    <audio class="song1" src="Tracks/.mp3"></audio>
                    <a onclick="setrid(2)" data-bs-toggle="modal" data-bs-target="#exampleModal"><i id="add" class="material-icons-outlined">add_box</i></a>
                </div>
                </div>
              </li>
              <h5>Responded</h5>
  ...
  <!-- Footer -->
    ...
    <script>
      ...
      window.onload = function (){
        ...
        xhr.open("POST","php/showRequests.php",true);
        xhr.onload = ()=>{
    ...
    function setrid(rid){
      var getrid = document.getElementById('rid');
      getrid.value = rid;
    }
