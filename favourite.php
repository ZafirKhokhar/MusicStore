          ...
          <div class="sidebar">
              <ul>
                  ...
                  <?php
                    if($_SESSION['uid'] == "")
                    {
                      echo '<li class="active"><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fas fa-heart"></i>Favourite</a></li>';
                    }
                    else {
                      echo '<li class="active"><a href="favourite.php"><i class="fas fa-heart"></i>Favourite</a></li>';
                    }
                  ?>
  ...
  <!-- Footer -->
    ...
    window.onload = function(){
        ...
        if(userid != ""){
            ...
            xhr.open("POST","php/favList.php",true);
            xhr.onload = ()=>{
    ...
    function removeFav(removesong){
      let songid = removesong;
        if(songid != ""){
            // searchsong.classList.add("active");
            let xhr = new XMLHttpRequest();
            xhr.open("POST","php/delFav.php",true);
            xhr.onload = ()=>{
                if(xhr.readyState === XMLHttpRequest.DONE){
                    if(xhr.status === 200){
                        let data = xhr.response;
