...
<body>
  <?php
    ...
    include_once "php/config.php";
    error_reporting(0);
    $sqlu = mysqli_query($conn, "SELECT * FROM users WHERE uid = '{$_SESSION['uid']}'");
        ...
        <div class="right-container">
            <div class="wrapper">
                ...
                <div class="controls">
                    ...
                    <div class="favorite">
                      <i id="favorite-tick" class="material-icons">favorite_border</i>
                    </div>
                </div>
            </div>
...
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <!-- Footer -->
    ...
    <script>
      let allMusic = <?php echo json_encode($arraydata);  ?>;
